                ...
                if (this._tickers.TryGetValue(actionParameter, out dynamic tickerData))
                {
                    if (tickerData != null)
                    {
                        ...
                        using (var bitmapBuilder = new BitmapBuilder(imageSize))
                        {
                            ...
                            bitmapBuilder.DrawText(Math.Round((Single)tickerData.price, 2).ToString(), (Int32)x1, (Int32)y2, (Int32)w, (Int32)h, color, imageSize == PluginImageSize.Width90 ? 25 : 9, imageSize == PluginImageSize.Width90 ? 2 : 0, 10);
